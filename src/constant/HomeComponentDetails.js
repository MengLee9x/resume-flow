export const skillContent = [
    {
        ...
        description: "As a developer, I find myself most captivated by the power and foxibility of NEXT.js. I'm always eager to dive into new projects that leverage NEXTjs and discover innovative ways to create fast. scalable, and user-friendly applications",
        color: "bg-softOrange",
        imageName: "code-icon"
    },
    {
        ...
        color: "bg-paleBlueGray",
        imageName: "app-icon"
    },
    {
        id: 3,
        profession: "UI/UX Designing",
